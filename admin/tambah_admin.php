...
if(isset($_POST["submit"])){
    if(tambah_admin($_POST) > 0){
        $sukses = "Admin berhasil ditambahkan";
    } else {
        $err = "Gagal menambahkan admin";
    }
}
?>
<!DOCTYPE html>
...
<body class="bg-green-50 min-h-screen flex items-center justify-center">
    <div class="bg-white rounded-xl shadow-lg p-8 w-full max-w-md">
        <h2 class="text-2xl font-bold mb-6 text-green-800 text-center">Tambah Admin</h2>
        <?php if($err): ?>
        ...
        <form method="post" autocomplete="off" action="#">
            ...
            <div class="flex justify-between">
                <a href="jumlah_admin.php" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded">Kembali</a>
